    ...
    <div>
      ...
      >
        ...
        <List>
          ...
          <ListItem component={Link} to="/calender" className="hover:bg-[#003FAD]">
            <ListItemIcon className="text-black">
              <ViewInArIcon />
            </ListItemIcon>
          ...
          <ListItem component={Link} to="/Pie-Chart" className="hover:bg-[#003FAD]">
            <ListItemIcon className="text-black">
              <PieChartOutlineRoundedIcon /> {/* Replaced with PieChartOutlineRoundedIcon */}
            </ListItemIcon>
            {!showIconsOnly && <ListItemText primary="Pie Chart" />}
          </ListItem>
