...
type EmployeesProps = {
  userId?: number;
  activeTab: 'personal' | 'financial';
  setActiveTab: React.Dispatch<React.SetStateAction<'personal' | 'financial'>>;
};

const Employees: React.FC<EmployeesProps> = ({ userId, activeTab, setActiveTab }) => {
